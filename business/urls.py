...
urlpatterns = [
    ...
    url('credit-repair-1/', login_required(CreditRepair1View.as_view(), login_url='/user/login'), name='credit_repair_1'),
    url('credit-repair-2/', login_required(CreditRepair2View.as_view(), login_url='/user/login'), name='credit_repair_2'),
    url('credit-repair-3/', login_required(CreditRepair3View.as_view(), login_url='/user/login'), name='credit_repair_3'),
    url('credit-repair-4/', login_required(CreditRepair4View.as_view(), login_url='/user/login'), name='credit_repair_4'),
    url('credit-repair-5/', login_required(CreditRepair5View.as_view(), login_url='/user/login'), name='credit_repair_5'),
    url('credit-repair-6/', login_required(CreditRepair6View.as_view(), login_url='/user/login'), name='credit_repair_6'),
    url('credit-repair-7/', login_required(CreditRepair7View.as_view(), login_url='/user/login'), name='credit_repair_7'),
    url('credit-repair-8/', login_required(CreditRepair8View.as_view(), login_url='/user/login'), name='credit_repair_8'),
    url('credit-repair-9/', login_required(CreditRepair9View.as_view(), login_url='/user/login'), name='credit_repair_9'),
    url('credit-repair-10/', login_required(CreditRepair10View.as_view(), login_url='/user/login'), name='credit_repair_10'),
    url('credit-repair-11/', login_required(CreditRepair11View.as_view(), login_url='/user/login'), name='credit_repair_11'),
    url('credit-repair-12/', login_required(CreditRepair12View.as_view(), login_url='/user/login'), name='credit_repair_12'),
    url('credit-repair-13/', login_required(CreditRepair13View.as_view(), login_url='/user/login'), name='credit_repair_13'),
    url('credit-repair-14/', login_required(CreditRepair14View.as_view(), login_url='/user/login'), name='credit_repair_14'),
    url('credit-repair-15/', login_required(CreditRepair15View.as_view(), login_url='/user/login'), name='credit_repair_15'),
    url('credit-repair-16/', login_required(CreditRepair16View.as_view(), login_url='/user/login'), name='credit_repair_16'),
    url('credit-repair-17/', login_required(CreditRepair17View.as_view(), login_url='/user/login'), name='credit_repair_17'),
]
